...
- [x] `Banco de Dados`
  ...
  - [x] Prisma
    ...
    - [x] Executando o primas:
      ...
      - Em seguida, ao criar um usuário vamos recebermos dados na requisão(`req`) que será uma promise do tipo `users`, vamos armazenar cada dado desse objeto `data` na sua própria const com `destructuring assignment`:

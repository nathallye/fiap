...
- ## [FIAP with teacher: Synchronous Content](fiap-with-teacher/README.md)
  ...
  - ### [Logic Challenges](fiap-with-teacher/logic-challenges/README.md)
    - #### [Multiplication Table](fiap-with-teacher/logic-challenges/01-logic/01-multiplication-table/README.md)
    - #### [Regular Expressions](fiap-with-teacher/logic-challenges/01-logic/02-regular-expressions/README.md)
